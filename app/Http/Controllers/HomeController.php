...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $housesSale = House::orderBy('id', 'desc')->saleType(SaleTypeOptions::BAN)->isExpired(false)->simplePaginate(4);
        $housesRent = House::orderBy('id', 'desc')->saleType(SaleTypeOptions::CHO_THUE)->isExpired(false)->simplePaginate(4);
