    ...
    <form accept-charset="UTF-8" enctype="multipart/form-data" action="{{ route('house.store') }}" method="POST" role="form" id="houseForm">
      ...
      <section>
        ...
        <div class="row">
          <div class="col-md-1">
            <div class="radio">
              <label><input type="radio" name="type" value="1" checked autocomplete="off">Bán</label>
            </div>
          </div>
          <div class="col-md-3">
            <div class="radio">
              <label><input type="radio" name="type" value="2" autocomplete="off">Cho thuê</label>
            </div>
          </div>
          <div class="col-md-2">
        ...
        <div class="row">
          @for ($i = 0; $i < count(HouseFeatureOption::getOptions());  $i++)
            @if (0 == $i % 6) <div class="col-md-3"> @endif
              <div class="checkbox">
                <label><input name="feature[]" type="checkbox" value="{{ $i }}"> {{ HouseFeatureOption::getLabel($i) }}</label>
              </div>
