...
<nav class="collapse in" id="collapseUserNav" role="navigation">
  <ul class="nav user-nav">
    @can('admin')
      ...
      <li><a href="{{ route('admin.design.index') }}">Dịch vụ đăng tin</a></li>
      <li><a href="{{ route('admin.design.index', 1) }}">Thiết kế</a></li>
      <li><a href="{{ route('admin.design.index', 2) }}">Nội thất</a></li>
      <li><a href="{{ route('admin.design.index', 3) }}">Thi công</a></li>
      <li><a href="{{ route('admin.design.index', 4) }}">Quản trị thông tin khác dịch vụ</a></li>

      <li class="user-nav-header">Thông tin chung HOUSE</li>
      <li><a href="{{ route('profile.edit') }}">Thay đổi thông tin cá nhân</a></li>
      <li><a href="{{ route('password.edit') }}">Đổi mật khẩu</a> </li>
      <li><a href="{{ route('admin.article.create', 'id=1') }}">Quản trị phần hướng dẫn</a> </li>
      <li><a href="{{ route('message.index', 'inbox') }}">Hộp thư</a></li>
