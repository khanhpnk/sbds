<ul class="row">
  <li class="col-md-3">
    <ul>
      ...
      <li><a href="javascript:void(0)"><i class="fa fa-fax"></i>(305) 555-4447</a></li>
      <li><a href="javascript:void(0)"><i class="fa fa-facebook-official"></i>viethome360</a></li>
      <li><a href="javascript:void(0)"><i class="fa fa-skype"></i>luongduyhung</a></li>
      <li><a href="http://hoalanstudies.edu.vn" target="_blank"><i class="fa fa-globe"></i>http://hoalanstudies.edu.vn</a></li>
    </ul>
  </li>
  <li class="col-md-3">
    <ul>
