{{-- 
Chú ý: 
	Không tự ý sửa đổi hay xóa file này. 
Hướng dẫn:
	   Khi muốn sửa template cho email thì trước hết cần sửa file này, 
	   sau đó dùng tool (http://templates.mailchimp.com/resources/inline-css/) 
	   để áp dụng lại template cho hệ thống.
--}}
