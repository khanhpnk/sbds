<section>
	<header><h1 class="house-title">Nhà đất bán</h1></header>
			...
			<article class="col-md-3 col-sm-6">
				<div class="house-thumb">
					...
					<div class="house-thumb-cap">
						<header><h3 class="house-thumb-title"><span class="house-thumb-type">Bán</span> <a href="#">căn hộ chung cư cao cấp sông hồng</a></h3></header>
