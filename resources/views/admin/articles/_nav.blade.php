...
<div aria-label="Justified button group" role="group" class="btn-group btn-group-justified">
  <a role="button" class="btn btn-primary @if (1 == Input::get('id')) active @endif" href="{{ route('admin.article.create', 'id=1') }}">Giới thiệu về house360</a>
  ...
  <a role="button" class="btn btn-primary @if (5 == Input::get('id')) active @endif" href="{{ route('admin.article.create', 'id=6') }}">Thanh toán</a>
</div>
<hr>